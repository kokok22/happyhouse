...
public class HouseMapDaoImpl implements HouseMapDao {
	...
	@Override
	public List<DealDto> getDeal(String dong, String aptname, String sort) throws Exception {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			...
			if(aptname.equals(""))
				...
				sql.append("where d.dong = ? and d.AptName like '%"+aptname+"%'and d.AptName = i.AptName\n");
	...
	public List<DealDto> getAptInDong(String dong, String aptname, String sort) throws Exception {
		...
		try {
			...
			sql.append("FROM housedeal as d, houseinfo\n");
			if(aptname.equals(""))
